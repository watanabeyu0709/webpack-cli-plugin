...
var isArrayIter = __webpack_require__(34);
var anObject = __webpack_require__(9);
...
var Plugin = function () {
    ...
    (0, _createClass3.default)(Plugin, [{
        ...
        value: function init() {
             ...
             * @type {Set<string>}
             */
            var allowParams = new _set2.default(['zIndex', 'icon', 'shape', 'background', 'color', 'text', 'hover', 'btnLike', 'correct', 'position', 'animation', 'distance', 'ready', 'callback']);
            var userParams = new _set2.default();
            for (var i in this.option) {
                userParams.add(i);
            }
            var difference = new _set2.default([].concat((0, _toConsumableArray3.default)(userParams)).filter(function (x) {
                return !allowParams.has(x);
            })); //计算用户的参数和允许参数的差集
            if (difference.size > 0) {
                //有未定的参数键值对
                console.warn('\'' + (0, _from2.default)(difference) + '\' are not allowed , param \'option\' can only accept these configuration : \'' + (0, _from2.default)(allowParams) + '\' -- yu-scroll-top');
            }

            /**
             * @description 无参数初始化参数
             */
            if (!this.option || (0, _stringify2.default)(this.option) === "{}") {
                this.option = {
                    zIndex: '',
                    icon: '',
                    shape: '',
             ...
             */
            //icon
            var icon = this.option.icon ? '<i class="iconfont icon-' + this.option.icon + '"></i>' : '';
            //text
            var text = this.option.text ? '<i class="text">' + this.option.text + '</i>' : '';
            //构建基本DOM
            var domScroll = document.createElement('section');
            ...
            if (this.option.btnLike) {
                ...
                if (this.option.background) {
                    domScroll.style.boxShadow = (0, _color2.default)(this.option.background).lighten(0.2) + ' 3px 3px 0';
                }
            }
            //变化zindex
            ...
            if (this.option.position) {
                for (var index in this.option.position) {
            ...
            if (this.option.animation) {
                ...
                domScroll.addEventListener("click", function () {
                    ...
                    var scrollToptimer = setInterval(function () {
                        ...
                        if (top === 0) {
                            if (_this2.option.callback) {
                                _this2.option.callback();
                            }
...
var $iterDefine = __webpack_require__(17);
var step = __webpack_require__(37);
...
// module
exports.push([module.i, "@charset \"UTF-8\";\n/*省略显示点点点,移动端通用*/\n#scrollTop {\n  position: fixed;\n  right: 15px;\n  bottom: 15px;\n  background: rgba(0, 0, 0, 0.6);\n  border-radius: 50%;\n  color: white;\n  min-width: 50px;\n  min-height: 50px;\n  text-align: center;\n  z-index: 98;\n  cursor: pointer;\n  font-size: 12px;\n  display: table;\n  line-height: 1.3;\n  padding: 3px;\n  /*模仿按钮*/\n  /*有icon有文字*/\n  /*hover效果 icon文字切换显示*/\n  /*隐藏*/ }\n  #scrollTop > * {\n    font-style: normal;\n    display: table-cell;\n    vertical-align: middle; }\n    #scrollTop > *.iconfont {\n      font-size: 20px;\n      font-style: normal;\n      line-height: 1; }\n  #scrollTop.btnLike {\n    box-shadow: black 3px 3px 0; }\n    #scrollTop.btnLike:active {\n      opacity: 0.8; }\n  #scrollTop.withText .inner {\n    display: table-cell;\n    vertical-align: middle; }\n    #scrollTop.withText .inner > * {\n      display: block;\n      font-style: normal; }\n      #scrollTop.withText .inner > * i.iconfont.icon-none {\n        display: none; }\n  #scrollTop.hover .text {\n    display: none; }\n  #scrollTop.hover:hover .iconfont {\n    display: none; }\n  #scrollTop.hover:hover .text {\n    display: table-cell; }\n  #scrollTop.hidden {\n    display: none; }\n", ""]);
...
var colorString = __webpack_require__(97);
var convert = __webpack_require__(100);
...
var swizzle = __webpack_require__(98);
...
var isArrayish = __webpack_require__(99);
